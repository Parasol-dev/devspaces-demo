Devspaces-org.Summitdemo Run Role
========================
...
- name: Execute tasks on servers
  hosts: servers
  roles:
    - role: devspaces-org.summitdemo.run
      run_x: 42
```
...
```yaml
- name: Initialize the run role from devspaces-org.summitdemo
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of run role
      ansible.builtin.include_role:
        name: devspaces-org.summitdemo.run
      vars:
        run_x: 42
```
